...
public class Niumowang extends Monster {
	...
	public Niumowang(int px, int py) {
		super(px, py, h, sp, wd, ht, rg, at, type, attF, name, true);
	}
	...
	public EBall shootBall(double x2, double y2) {
		return new Banana(getX(0.5), getY(0.5), x2, y2, bp);
	}
	...
	public void attackAnimation2() {
		...
		if (attackProgress == 8) {
			balls.add(shootBall(getX(0.5) - 1, getY(0.5) - 1));
			balls.add(shootBall(getX(0.5) - 1, getY(0.5) + 1));
			balls.add(shootBall(getX(0.5) + 1, getY(0.5) + 1));
			balls.add(shootBall(getX(0.5) + 1, getY(0.5) - 1));
			balls.add(shootBall(getX(0.5) + 1, getY(0.5)));
			balls.add(shootBall(getX(0.5) - 1, getY(0.5)));
			balls.add(shootBall(getX(0.5), getY(0.5) + 1));
			balls.add(shootBall(getX(0.5), getY(0.5) - 1));

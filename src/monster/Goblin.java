...
public class Goblin extends Monster{
	private Image stand = new Image("file:images/monster/Goblin/Run.png");
	private Image im_att = new Image("file:images/monster/Goblin/Attack.png");
	...
	public Goblin(int px, int py) {
		super(px, py, h, sp, wd, ht, rg, at, type, attF, name, false);
	}
